...
运行我们构造的60个多样化query，每个最多重试2次，记录结果。
"""
...
DIVERSIFIED_TEST_CASES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "prediction": "可能失败",
        "prediction_reason": "跨层级名称筛选（广告主→计划）",
    },
    {
        "id": 5,
        "name": "两层名称查询 - 趋势",
    ...
    },
    {
        ...
        "prediction": "很可能失败",
        "prediction_reason": "两层名称筛选（广告主→ad_group）",
    },
    {
        "id": 12,
    ...
    },
    {
        ...
        "prediction": "很可能失败",
        "prediction_reason": "三层名称筛选（广告主→creative）",
    },
    {
        "id": 15,
    ...
    {
        "id": 31,
        "name": "ID where筛选多样化 - 没删掉",
        "query": "列出广告主6没删掉的那些广告计划四月份消耗和点击",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试2，同义词替换",
    },
    {
        "id": 32,
        "name": "ID where筛选多样化 - 筛选掉",
        "query": "广告主6，筛选掉已删除的，展示四月份各计划消耗点击数据",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "可能失败",
        "prediction_reason": "\"筛选掉\"表述方式原案例没有",
    },
    {
        "id": 33,
        "name": "ID where筛选多样化 - 口语",
        "query": "找一下广告主6下面，状态是未删除的广告计划，四月份花了多少点了多少",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "可能失败",
        "prediction_reason": "口语化表述",
    },
    {
        "id": 34,
        "name": "ID having筛选多样化 - 超过10块钱",
        "query": "广告主6四月份哪些计划总共花了超过10块钱",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试3，换说法",
    },
    {
        "id": 35,
        "name": "ID having筛选多样化 - 找出列出来",
        "query": "找出广告主6四月总消耗大于10的广告计划列出来",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "可能失败",
        "prediction_reason": "语序变化",
    },
    {
        "id": 36,
        "name": "ID having筛选多样化 - 帮我筛选",
        "query": "帮我筛选广告主6，四月消耗超过10的计划有哪些",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
        "prediction": "可能失败",
        "prediction_reason": "表述方式不同",
    ...
    {
        "id": 37,
        "name": "ID多指标表格多样化 - 用表格展示",
        "query": "用表格展示广告主6四月份的展示、点击、消耗、转化",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试7，表述口语化",
    },
    {
        "id": 38,
        "name": "ID多指标表格多样化 - 同义词替换",
        "query": "广告主6四月份，把曝光点击花费转化这四个指标给我列出来",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "同义词替换（曝光=展示，花费=消耗）",
    },
    {
        "id": 39,
        "name": "ID多指标表格多样化 - 表格形式",
        "query": "给我广告主6四月各项核心指标数据，表格形式",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "意图明确",
    },
    {
        "id": 40,
        "name": "ID对比多样化 - 涨了跌了",
        "query": "广告主6四月花费和三月比，涨了还是跌了",
        "expected_analysis_type": "period_comparison",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试4，换说法",
    },
    {
        "id": 41,
        "name": "ID对比多样化 - 差异多大",
        "query": "对比广告主6三月份和四月份的总消耗，差异多大",
        "expected_analysis_type": "period_comparison",
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "表述方式不同",
    },
    {
        "id": 42,
        "name": "ID对比多样化 - 指代",
        "query": "上个月跟这个月比，广告主6消耗哪个多",
        "expected_analysis_type": "period_comparison",
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "指代需要推理时间",
    },
    {
        "id": 43,
        "name": "ID受众分布多样化 - 占比分别多少",
        "query": "广告主6四月份，不同性别用户消耗占比分别是多少",
        "expected_analysis_type": "audience_distribution",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试5，换说法",
    },
    {
        "id": 44,
        "name": "ID受众分布多样化 - 划分饼图",
        "query": "按性别划分，广告主6四月消耗分布饼图",
        "expected_analysis_type": "audience_distribution",
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "表述方式不同",
    ...
    },
    {
        ...
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试8，更简洁",
    },
    {
        "id": 47,
        "name": "ID摘要多样化 - 总的",
        "query": "给我广告主6四月总的展示点击消耗转化",
        "expected_analysis_type": "summary",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "原e2e测试8，换说法",
    },
    {
        "id": 48,
        "name": "ID摘要多样化 - 数据概览",
        ...
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "简洁但意图明确",
    },

    # 三、其他层级拓展场景
    {
        "id": 49,
        "name": "Ad Group TopN - 消耗前三",
    ...
    },
    {
        ...
        "expected_target_level": "ad_group",
        "prediction": "可能失败",
        "prediction_reason": "排序+TopN，原案例少",
    },
    {
        "id": 51,
        "name": "Creative筛选 - 点击大于100",
        "query": "广告主6四月份点击量超过100的创意有哪些",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "creative",
        "prediction": "预期成功",
        "prediction_reason": "结构清晰",
    },
    {
        ...
        "expected_target_level": "creative",
        "prediction": "可能失败",
        "prediction_reason": "排序+TopN",
    },
    {
        "id": 53,
        "name": "受众分布 - 年龄分组",
        "query": "广告主6四月份消耗按年龄分组分布",
        "expected_analysis_type": "audience_distribution",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "结构清晰，只换维度",
    },
    {
        "id": 54,
        "name": "受众分布 - 操作系统占比",
    ...
    },
    {
        "id": 55,
        "name": "受众分布 - 名称+城市",
        "query": "广告主 digital_0 四月份消耗按城市分布",
        "expected_analysis_type": "audience_distribution",
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "按名称筛选+受众分布",
    },
    ...
    # 四、口语化/模糊表达场景
    {
        ...
        "expected_target_level": "advertiser",
        "prediction": "很可能失败",
        "prediction_reason": "极度简洁，缺少时间和分析类型",
    },
    {
        "id": 57,
        "name": "简洁 - 名称+月份",
        "query": "广告主 digital_0四月",
        "expected_analysis_type": "summary",
        "expected_target_level": "advertiser",
        "prediction": "很可能失败",
        "prediction_reason": "缺少分析类型，需要推理",
    },
    {
        "id": 58,
        "name": "全模糊 - 最近数据",
        ...
        "expected_target_level": "advertiser",
        "prediction": "很可能失败",
        "prediction_reason": "全模糊，需要推理时间和意图",
    },
    {
        "id": 59,
        "name": "模糊 - 最近表现",
        ...
        "expected_target_level": "advertiser",
        "prediction": "可能失败",
        "prediction_reason": "模糊提问，需要推理时间",
    },
    {
        "id": 60,
        "name": "口语化 - 广告主六",
        "query": "帮我查一下广告主六四月份数据",
        "expected_analysis_type": "summary",
        "expected_target_level": "advertiser",
        "prediction": "预期成功",
        "prediction_reason": "意图明确，时间层级都有",
    },
]
...
def parse_args():
    """解析命令行参数"""
    parser = argparse.ArgumentParser(description="多样化自然语言Query测试")
    parser.add_argument(
        "--tests",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="diversified_test_results.json",
        help="将结果保存到JSON文件（默认: diversified_test_results.json）"
    )
...
async def main():
    ...
    print(f"🚀 开始运行 多样化自然语言Query测试，共 {len(selected_tests)} 个测试用例")
    ...
    md_path = script_dir.parent / "docs/test_cases/diversified_test_results.md"
