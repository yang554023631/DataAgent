#!/usr/bin/env python3
"""
只跑指定的8个测试用例，手动加上四月份时间（因为原始query没提时间，系统要求澄清是对的，但我们想测试结构解析能力）
"""
...
TEST_CASES = [
    {
        ...
        "query": "找出 digital_0 四月份 名称带 digital 的广告计划，按消耗排序",
    ...
    },
    {
        ...
        "query": "在 digital_0 四月份 中找出名称包含六一八的所有广告组，按消耗降序排列前三",
        "expected_analysis_type": "entity_table",
    ...
    },
    {
        ...
        "query": "列出 digital_0 四月份 名称含尊享的所有创意及消耗",
        "expected_analysis_type": "entity_table",
    ...
    },
    {
        ...
        "query": "digital_0 四月份 投放中的广告计划，名称含有 best，列出消耗和点击",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "campaign",
    },
    {
        ...
        "query": "找出 digital_0 四月份 下名称含 mini 的创意，点击量大于50的",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "creative",
    },
    {
        ...
        "query": "列出广告主6 四月份 点击率从高到低排前五的广告组",
        "expected_analysis_type": "entity_table",
        "expected_target_level": "ad_group",
    },
    {
...
async def run_single_test(
    ...
    for attempt in range(max_retries):
        ...
        # 检查关键结构是否正确
        print(f"   ✓ 成功! advertiser_ids={result.advertiser_ids}, metrics={result.metrics}, top_n={result.top_n}, sort={result.sort}")
...
async def main():
    ...
    # 保存结果
    output_path = Path("test_8_results.json")
