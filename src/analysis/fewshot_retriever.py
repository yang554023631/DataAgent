...
try:
    from backend.src.rag.retriever import VectorRetriever, RetrievalResult
    from backend.src.rag.database import get_db_session
    from backend.src.rag.embedding import get_embedding_provider
    HAS_RAG = True
except ImportError:
